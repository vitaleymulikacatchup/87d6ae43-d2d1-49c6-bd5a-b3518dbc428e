...
export const metadata: Metadata = {
  title: "Grand Azure Hotel - Luxury Redefined | 5-Star Accommodations",
  description: "Experience unparalleled luxury at Grand Azure Hotel. World-class service, elegant suites, fine dining, and premium amenities in the heart of the city.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, fine dining, spa services, business travel, luxury suites",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Grand Azure Hotel - Luxury Redefined",
    description: "Experience unparalleled elegance and world-class service at our 5-star luxury hotel.",
